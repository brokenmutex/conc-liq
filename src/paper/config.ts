...
export const paperPolicySchema = z.union([executionPolicySchema, illustrativePolicySchema]);
export function paperPolicy(overrides: unknown = {}) {
  return executionPolicySchema.parse({ ...DEFAULT_PAPER_POLICY, ...(overrides as object) });
}

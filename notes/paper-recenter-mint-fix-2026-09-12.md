...
The subsequent [liquidity-share and fee-accounting change](paper-liquidity-dilution-2026-09-12.md) replaces the 2% veto with a warning and adds a narrowly permitted policy migration. The statements above describe the earlier mint-composition release and its original deployment boundary.

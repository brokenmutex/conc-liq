...
These chain/holding parameters are proposals only. This review does not change the running chain or risk rules. The previously approved USDG grace remains a separate deployment.
